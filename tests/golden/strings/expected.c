...
int Main(void) {
    ...
    unsigned int _t979;
    _t979 = String_Len(hello);
    PrintInt(_t979);
    PrintLine("");
    const char* greeting;
    const char* _t980;
    _t980 = String_Concat(hello, ", ");
    greeting = _t980;
    const char* greeting2;
    const char* _t981;
    _t981 = String_Concat(greeting, world);
    greeting2 = _t981;
    const char* full;
    const char* _t982;
    _t982 = String_Concat(greeting2, "!");
    full = _t982;
    PrintLine("Concatenated:");
    PrintLine(full);
    bool _t983;
    _t983 = String_Eq(hello, "Hello");
    ...
    endif321:;
    bool _t984;
    _t984 = String_Eq(hello, world);
    _t985 = !_t984;
    if (!_t985) goto endif323;
    {
